    ...
    def __str__(self):
        if self.reserve:
            return (f'Название: {self.title}, Автор: {self.author},'
                    f' страниц: {self.count_page}, материал: {self.page_material}, {self.reservation()}')
        print(20 * '*')
        return f'Название: {self.title}, Автор: {self.author}, страниц: {self.count_page}, материал: {self.page_material}'
